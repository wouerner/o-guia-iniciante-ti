...
[Subáreas do Desenvolvimento de Software](#subáreas-do-desenvolvimento-de-software)

[Segurança da Informação](#segurança-da-informação)

[Subáreas da Segurança da Informação](#subáreas-da-segurança-da-informação)

[Ciência de Dados e Inteligência Artificial](#ciência-de-dados-e-inteligência-artificial)

[Subáreas de Ciência de Dados e Inteligência Artificial](#subáreas-de-ciência-de-dados-e-inteligência-artificial)

[Infraestrutura e Redes](#infraestrutura-e-redes)

[Subáreas de Infraestrutura e Redes](#subáreas-de-infraestrutura-e-redes)

[Escolhendo o Curso Certo: Bacharelado, Tecnólogo ou Licenciatura?](#escolhendo-o-curso-certo:-bacharelado,-tecnólogo-ou-licenciatura?)

[Pesquisando a Instituição de Ensino: Onde Estudar?](#pesquisando-a-instituição-de-ensino:-onde-estudar?)

[2\. Durante a Graduação](#2.-durante-a-graduação)

[A Vida de Estudante de TI: Dicas para o Primeiro Ano e Além](#a-vida-de-estudante-de-ti:-dicas-para-o-primeiro-ano-e-além)

[Aproveitando a Faculdade ao Máximo: Projetos, Hackathons e Eventos](#aproveitando-a-faculdade-ao-máximo:-projetos,-hackathons-e-eventos)

[Estágios e Experiência Profissional: A Ponte para o Mercado](#estágios-e-experiência-profissional:-a-ponte-para-o-mercado)

[Networking: Construa Sua Rede de Contatos](#networking:-construa-sua-rede-de-contatos)

[3\. O Futuro na Área de TI](#3.-o-futuro-na-área-de-ti)

[Especializações: Onde Você Quer Chegar?](#especializações:-onde-você-quer-chegar?)

[Certificações: Um Passo a Mais na Sua Carreira](#certificações:-um-passo-a-mais-na-sua-carreira)

[O Mercado de Trabalho em TI: Tendências, Salários e Como se Preparar](#o-mercado-de-trabalho-em-ti:-tendências,-salários-e-como-se-preparar)
...
Se você está pensando em fazer faculdade de TI, é normal se sentir um pouco perdido. O mundo da tecnologia é vasto e está em constante mudança. Este guia vai te ajudar a ter um panorama claro para tomar a melhor decisão.
...
#### **1. Estou entrando na área só pelo hype e pelo dinheiro?**
...
#### **2. Meu principal objetivo é trabalhar de casa?**
...
#### **3. O que eu já sei é o bastante para começar?**
...
**Reflexão:** Você está disposto a reaprender conceitos que achava que já dominava e a mergulhar em matérias teóricas que, à primeira vista, parecem "chatas"?
...
É a área que cria programas, sites, aplicativos e sistemas. Você pode trabalhar como desenvolvedor **front-end** (a parte visual que o usuário interage), **back-end** (a lógica e a parte de dados por trás da aplicação) ou **full-stack** (que faz as duas coisas).
...
1. Desenvolvimento Web  
   “O autor desse guia conhece profundamente essa area cm atuação de mais de 15 anos”  
...
2. Desenvolvimento Mobile  
   “Existe mais aparelhos celulares do que brasileiro no Brasil, então se existe uma area consolidada e essa”  
...
3. Desenvolvimento de Jogos \- GameDev  
...
* **Level Designer:** Cria os cenários, mapas e desafios do jogo. Este profissional não apenas constrói ambientes visualmente atraentes, mas também garante que o fluxo do jogo seja lógico e divertido, posicionando inimigos, itens e obstáculos.  
...
5. Desenvolvimento RPA, automação e Low-code no-code.
...
A ascensão do RPA e do Low-Code/No-Code criou novas oportunidades de carreira e um tipo de profissional inovador:
...
**Claro. A área de Qualidade e Teste (QA) é muito mais do que apenas encontrar erros. Ela se divide em subáreas especializadas, cada uma focada em um aspecto diferente para garantir que o produto final seja robusto e confiável.**
...
* **Testes de Performance: Medem a velocidade, estabilidade e capacidade de resposta do software. Inclui Testes de Carga (para ver como o sistema se comporta com muitos usuários) e Testes de Estresse (para encontrar o limite máximo do sistema antes que ele falhe).**  
...
“Nao voce nao vai se transformar no Mr Robot, mas pode ser bom a ponto de ganhar mais de 20 mil por mês”
...
2. Segurança de Redes (Network Security)  
   ...
   1. Falar sobre mac adress  
3. Segurança de Aplicações (Application Security) (AppSec)  
   Dedicada a garantir que os softwares e sites sejam seguros desde o seu desenvolvimento.  
   1. CVS  
4. Análise de Vulnerabilidades e Teste de Invasão (Penetration Testing) (PenTest)  
   O profissional desta área é o "hacker ético". Ele simula ataques para encontrar e explorar falhas de segurança.  
5. Governança, Risco e Compliance (GRC) “importante mais muito chato\!”  
...
6. Resposta a Incidentes e Forense Digital (Policia Digital)  
...
“Essa e area da moda em 2025, e acredito que vai continuar por pelo menos 10 anos\! Oremos para IA não roubar nossos empregos”
...
4. Análise de Dados (Data Analytics)  “ou criador de gráficos infinitos”   
...
1. Administração de Sistemas e Servidores  
...
“Desde que você estudo de verdade, tanto faz seu titulo”
...
FAQ  
Qual contrata mais? Front, back ou mobile?  
Fullstack

Qual curso de logica de programação fazer?  
guanabara  
nelio alves

complementar a faculdade?  
object calistenics

Para o que serve a faculdade \>\> 